...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen transition-all duration-300 ${theme.colors.background}`}
      >
        {/* Navigation */}
        <nav
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      addNotification(
                        `Switched to ${themes[e.target.value].name} theme`,
                      );
                    }}
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                >
                  A comprehensive Next.js application showcasing modern web
                  development patterns with extensive Tailwind CSS styling and
                  responsive design.
                </p>
              </div>
            ...
            >
              ...
              >
                © 2024 NextApp. All rights reserved. Built with Next.js and
                Tailwind CSS.
              </p>
            </div>
          </div>
