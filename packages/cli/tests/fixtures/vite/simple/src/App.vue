    ...
    <section class="relative py-20">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Fast, modern development with Vue 3 Composition API, Vite, and
          Tailwind CSS
        </p>
        ...
        >
          ...
          <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <!-- Demo Output -->
              <div
                class="bg-gray-50 rounded-lg p-6 min-h-64 flex items-center justify-center"
              >
...
const runDemo = async () => {
  ...
  if (selectedDemo.value === "data") {
    ...
    for (let i = 0; i < steps; i++) {
      ...
      dataViz.value = dataViz.value.map(
    ...
    await new Promise((resolve) =>
      setTimeout(resolve, 2000 / animationSpeed.value),
    );
  }
