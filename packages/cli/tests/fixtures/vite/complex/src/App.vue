<template>
  ...
  >
    ...
    <div v-else>
      ...
      <!-- Notifications Panel -->
      <div v-if="showNotifications" class="fixed top-16 right-4 z-50 max-w-sm">
        <div
          :class="[
        ...
        >
          ...
          <div
            v-if="notifications.length === 0"
            :class="['text-sm', currentTheme.textMuted]"
          >
            No notifications
          </div>
      ...
      <main class="flex-1">
        ...
        >
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div class="text-center">
              ...
              >
                Experience the power of Vue 3 with Vite, featuring extensive
                Tailwind CSS styling, responsive design, and modern development
                patterns.
              </p>
              <div
        ...
        <!-- Demo Section -->
        <section v-if="activeSection === 'demo'" class="py-16">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              :class="[
            ...
            >
              ...
              <div v-else-if="selectedDemoType === 'chart'" class="space-y-6">
                <h3 :class="['text-xl font-semibold', currentTheme.text]">
                  Data Visualization
                </h3>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    <div class="space-y-4">
                      ...
                      >
                        ...
                        <span :class="['flex-1', currentTheme.text]">{{
                          item.label
                        }}</span>
                        <div
                  ...
                  >
                    ...
                    <div :class="['text-sm', currentTheme.textMuted]">
                      Total Performance
                    </div>
                  </div>
                </div>
                  ...
                  >
                    ...
                    >
                      <div class="flex justify-between items-start mb-2">
                        <h4 :class="['font-semibold', currentTheme.text]">
                          {{ event.title }}
                        </h4>
                        <span :class="['text-sm', currentTheme.textMuted]">{{
                          event.date
                        }}</span>
                      </div>
        ...
        <!-- Features Section -->
        <section v-if="activeSection === 'features'" class="py-16">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2
              :class="[
                'text-3xl font-bold text-center mb-12',
        ...
        <!-- About Section -->
        <section v-if="activeSection === 'about'" class="py-16">
          <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <p :class="['text-lg leading-relaxed mb-6', currentTheme.text]">
                ViteApp is a comprehensive demonstration of modern web
                development using Vue 3, Vite, and Tailwind CSS. This
                application showcases advanced patterns including reactive state
                management, dynamic theming, complex animations, and responsive
                design.
              </p>
              <p :class="['text-lg leading-relaxed', currentTheme.textMuted]">
                Built with performance and developer experience in mind, this
                project demonstrates how modern tools can create highly
                interactive and visually appealing web applications while
      ...
      <!-- Footer -->
      <footer
        :class="['border-t mt-16', currentTheme.cardBg, currentTheme.border]"
      >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="col-span-1 md:col-span-2">
              ...
              <p :class="['text-sm leading-relaxed', currentTheme.textMuted]">
                A demonstration of Vue 3 + Vite + Tailwind CSS showcasing modern
                web development patterns with extensive styling and interactive
                components.
              </p>
            </div>
            <div>
          ...
          <div :class="['mt-8 pt-8 border-t text-center', currentTheme.border]">
            <p :class="['text-sm', currentTheme.textMuted]">
...
const timelineEvents = [
  {
    ...
    date: "2024-01",
    description: "Set up Vue 3 + Vite project structure",
  },
  {
    title: "Tailwind Integration",
    date: "2024-02",
    description: "Configured Tailwind CSS with custom design system",
  },
  {
    title: "Component Development",
    date: "2024-03",
    description: "Built reusable components with TypeScript",
  },
  {
    title: "Interactive Features",
    date: "2024-04",
    description: "Added animations and dynamic theming",
  },
];
...
const features = [
  {
    ...
    description:
      "Powered by Vite for instant development and optimal build performance",
  ...
  },
  {
    ...
    description:
      "Crafted with Tailwind CSS for consistent and responsive design",
...
const triggerCardAnimation = (index: number) => {
  console.log(
    `Card ${index} clicked with animation speed ${animationSpeed.value}`,
  );
};
