...
describe('HtmlExtractor', () => {
  ...
  describe('extractFromFile', () => {
    ...
    it('should reject files exceeding size limit', async () => {
      ...
      await expect(extractor.extractFromFile('/large.html')).rejects.toThrow(FileReadError);
    });
    ...
    it('should handle file read errors', async () => {
      ...
      await expect(extractor.extractFromFile('/nonexistent.html')).rejects.toThrow(FileReadError);
    });

    it('should handle file stat errors', async () => {
      mockFs.stat.mockRejectedValue(new Error('Permission denied'));

      await expect(extractor.extractFromFile('/forbidden.html')).rejects.toThrow(FileReadError);
    });
    ...
    it('should handle timeout for large files', async () => {
      ...
      await expect(shortTimeoutExtractor.extractFromFile('/slow.html')).rejects.toThrow('timeout');
    });
  });
  ...
  describe('Error Handling', () => {
    it('should throw HtmlParsingError for invalid HTML processing', async () => {
      ...
      await expect(extractor.extractFromString(invalidHtml)).rejects.toThrow(HtmlParsingError);
    });
