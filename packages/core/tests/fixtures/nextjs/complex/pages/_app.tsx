  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A complex Next.js application with extensive Tailwind CSS usage"
        />
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="col-span-1 md:col-span-2">
                <h3 className={`text-lg font-semibold mb-4 ${theme.colors.text}`}>NextApp</h3>
                <p
                ...
                >
                  A comprehensive Next.js application showcasing modern web development patterns
                  with extensive Tailwind CSS styling and responsive design.
                </p>
              </div>

              {/* Quick Links */}
              <div>
                <h4 className={`text-md font-medium mb-4 ${theme.colors.text}`}>Quick Links</h4>
              ...
              {/* Social Links */}
              <div>
                <h4 className={`text-md font-medium mb-4 ${theme.colors.text}`}>Connect</h4>
