...
import { BasePostCSSEnigmaPlugin, EnigmaPluginContext, PluginConfig } from '../types/plugins';
        ...
        if (options.minifyValues) {
          root.walkDecls((decl: Declaration) => {
            ...
            if (decl.prop === 'font-family') {
              decl.value = decl.value.replace(/["']([^"']+)["']/g, (match, font) => {
 ...
 */
export function createMyPostCSSPlugin(options: MyPostCSSPluginOptions = {}): MyPostCSSPlugin {
