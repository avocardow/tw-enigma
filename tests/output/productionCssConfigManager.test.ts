...
describe('ProductionCssConfigManager', () => {
  ...
  describe('Performance Budget Validation', () => {
    ...
    it('should detect inconsistent budget relationships', () => {
      ...
      expect(result.isValid).toBe(false);
      expect(result.errors.some(e => e.includes('chunk size') && e.includes('bundle size'))).toBe(true);
      expect(result.errors.some(e => e.includes('total size') && e.includes('bundle size'))).toBe(true);
    });
  ...
  describe('Configuration Validation', () => {
    ...
    it('should detect conflicting configuration options', () => {
      ...
      expect(result.warnings.some(w => 
        w.includes('single') && w.includes('chunking')
      )).toBe(true);
    });
  ...
  describe('Configuration Serialization', () => {
    ...
    it('should handle serialization of complex nested objects', () => {
      ...
      expect(deserialized.chunking?.routes).toEqual(['/home', '/about', '/contact']);
    });
  });
}); 