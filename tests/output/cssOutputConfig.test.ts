...
describe('Schema Validation', () => {
  describe('OutputStrategy validation', () => {
    it('should accept valid output strategies', () => {
      const validStrategies: OutputStrategy[] = ['single', 'chunked', 'modular'];
    ...
    it('should reject invalid output strategies', () => {
      expect(() => {
        validateCssOutputConfig({ ...validCompleteConfig, strategy: 'invalid' as any });
      }).toThrow();
    });
  });
  ...
  describe('ChunkingStrategy validation', () => {
    ...
    it('should reject invalid chunking strategies', () => {
      const config = {
        ...validCompleteConfig,
        chunking: { ...validCompleteConfig.chunking, strategy: 'invalid' as any }
      };
  ...
  describe('HashAlgorithm validation', () => {
    it('should accept valid hash algorithms', () => {
      const validAlgorithms: HashAlgorithm[] = ['md5', 'sha1', 'sha256', 'xxhash'];
  ...
  describe('DeliveryMethod validation', () => {
    it('should accept valid delivery methods', () => {
      const validMethods: DeliveryMethod[] = ['standard', 'preload', 'prefetch', 'async'];
...
describe('Configuration Merging', () => {
  describe('mergeCssOutputConfig', () => {
    ...
    it('should handle array properties correctly', () => {
      ...
      expect(merged.critical.viewports).toEqual([{ width: 1920, height: 1080 }]);
...
describe('CssOutputConfigManager', () => {
  ...
  describe('loadConfigFromPath', () => {
    ...
    it('should handle file not found', async () => {
      ...
      await expect(manager.loadConfigFromPath('/nonexistent/config.js'))
