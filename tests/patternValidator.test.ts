...
describe('SimplePatternValidator', () => {
  ...
  describe('Basic Validation', () => {
    ...
    it('identifies invalid classes correctly', () => {
      ...
      expect(result.warnings).toContain('Unknown Tailwind class: invalid-class-name');
    });
  });
  ...
  describe('Custom Classes', () => {
    ...
    it('allows adding custom classes after initialization', () => {
      ...
      expect(validator.validateClass('dynamic-custom').validationType).toBe('custom');
    });
  ...
  describe('Statistics', () => {
    it('provides validation statistics', () => {
      const classes = ['block', 'flex', 'invalid-1', 'bg-blue-500', 'invalid-2'];
