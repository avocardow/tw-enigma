...
describe("IntegrationManager", () => {
  ...
  describe("Plugin Management", () => {
    ...
    beforeEach(() => {
      mockPlugin = {
        ...
        initializeBuildTool: vi.fn().mockResolvedValue(undefined),
        processBuild: vi.fn().mockResolvedValue({
          success: true,
          assets: {},
          metrics: {} as any,
          warnings: [],
  ...
  describe("Build Process", () => {
    ...
    it("should handle build exceptions", async () => {
      mockPlugin.processBuild.mockRejectedValueOnce(
  ...
  describe("Error Handling", () => {
    ...
    it("should recover from HMR errors", async () => {
      const mockPlugin = {
        supportedBuildTools: ["vite"],
        hooks: {
          onFileChange: vi.fn().mockRejectedValue(new Error("HMR failed")),
        },
        initializeBuildTool: vi.fn(),
        processBuild: vi.fn().mockResolvedValue({
          success: true,
      ...
      await expect(
        manager.handleFileChange("/test-project/src/App.tsx"),
