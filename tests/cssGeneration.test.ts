...
import type { PatternFrequencyMap, AggregatedClassData } from '../src/patternAnalysis.js';
...
describe('CSS Generation Module', () => {
  ...
  describe('Validation Functions', () => {
    test('validateCssGenerationOptions accepts valid options', () => {
      expect(() => validateCssGenerationOptions(defaultCssOptions)).not.toThrow();
    });

    test('validateCssGenerationOptions rejects invalid options', () => {
      expect(() => validateCssGenerationOptions({
  ...
  describe('Pattern Classification', () => {
    test('classifyPattern correctly identifies atomic patterns', () => {
      const atomicClassData: AggregatedClassData = mockFrequencyMap.get('text-sm')!;
      const context = {
        frequencyMap: mockFrequencyMap,
        coOccurrencePatterns: [],
        nameGenerationOptions: mockNameOptions,
        options: defaultCssOptions,
        statistics: { processedClasses: 0, generatedRules: 0, skippedClasses: 0 },
      };
    ...
    test('classifyPattern correctly identifies utility patterns', () => {
      const utilityClassData: AggregatedClassData = mockFrequencyMap.get('bg-blue-500')!;
      const context = {
        frequencyMap: mockFrequencyMap,
        coOccurrencePatterns: [],
        nameGenerationOptions: mockNameOptions,
    ...
    test('classifyPattern correctly identifies component patterns', () => {
      const componentClassData: AggregatedClassData = mockFrequencyMap.get('flex items-center')!;
      const context = {
        frequencyMap: mockFrequencyMap,
        coOccurrencePatterns: [],
        nameGenerationOptions: mockNameOptions,
  ...
  describe('@apply Directive Handling', () => {
    ...
    test('generateApplyDirective throws error for empty classes', () => {
      expect(() => generateApplyDirective([], defaultCssOptions)).toThrow(ApplyDirectiveError);
    });
  ...
  describe('CSS Rule Sorting', () => {
    test('sortCssRules sorts by frequency', () => {
      ...
      const sorted = sortCssRules(rules, { ...defaultCssOptions, sortingStrategy: 'frequency' });
    ...
    test('sortCssRules sorts alphabetically', () => {
      ...
      const sorted = sortCssRules(rules, { ...defaultCssOptions, sortingStrategy: 'alphabetical' });
    ...
    test('sortCssRulesAdvanced respects multiple criteria', () => {
      ...
      const criteria = [
        ...
        { type: 'alphabetical' as const, direction: 'asc' as const, weight: 0.3 },
      ];
  ...
  describe('CSS Comments Generation', () => {
    test('generateCssComments creates minimal comments', () => {
      ...
      const comments = generateCssComments(rule, { ...defaultCssOptions, commentLevel: 'minimal' });
    ...
    test('generateCssComments creates detailed comments', () => {
      ...
      const comments = generateCssComments(rule, { ...defaultCssOptions, commentLevel: 'detailed' });
    ...
    test('generateCssComments creates verbose comments', () => {
      ...
      const comments = generateCssComments(rule, { ...defaultCssOptions, commentLevel: 'verbose' });
    ...
    test('generateCssComments returns empty string for none level', () => {
      ...
      const comments = generateCssComments(rule, { ...defaultCssOptions, commentLevel: 'none' });
  ...
  describe('Integration Functions', () => {
    ...
    test('generateOptimizedCss is alias for integrateCssGeneration', () => {
      const result1 = integrateCssGeneration(mockFrequencyMap, mockNameOptions, defaultCssOptions);
      const result2 = generateOptimizedCss(mockFrequencyMap, mockNameOptions, defaultCssOptions);
  ...
  describe('Advanced Pattern Analysis', () => {
    test('analyzePatternRelationships identifies relationships', () => {
      const classData: AggregatedClassData = mockFrequencyMap.get('flex items-center')!;
      const context = {
        frequencyMap: mockFrequencyMap,
        coOccurrencePatterns: [],
        nameGenerationOptions: mockNameOptions,
  ...
  describe('Error Handling', () => {
    ...
    test('InvalidCssError includes CSS details', () => {
      const error = new InvalidCssError('Invalid CSS', '.bad selector', 'selector');
    ...
    test('ApplyDirectiveError includes directive details', () => {
      ...
      const error = new ApplyDirectiveError('Bad directive', '@apply invalid', classes);
    ...
    test('PatternClassificationError includes class details', () => {
      const error = new PatternClassificationError('Classification failed', 'test-class');
  ...
  describe('Performance and Memory', () => {
    ...
    test('handles large frequency maps efficiently', () => {
      ...
      const result = integrateCssGeneration(largeFrequencyMap, mockNameOptions, defaultCssOptions);
